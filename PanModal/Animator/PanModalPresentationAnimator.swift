...
@MainActor public class PanModalPresentationAnimator: NSObject {
  /**
  ...
  private func panModalLayoutType(from context: UIViewControllerContextTransitioning) -> PanModalPresentable.LayoutType? {
    ...
    case .presentation:
      context.viewController(forKey: .to) as? PanModalPresentable.LayoutType
    case .dismissal:
      context.viewController(forKey: .from) as? PanModalPresentable.LayoutType
    }
  }
}
