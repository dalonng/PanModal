...
extension PanModalPresentable where Self: UIViewController {
  ...
  var longFormYPos: CGFloat {
    max(topMargin(from: longFormHeight), topMargin(from: .maxHeight)) + topOffset
  }
  ...
  static var keyWindow: UIWindow? {
    foregroundActiveWindowScene?.windows.first
  }

  static var foregroundActiveWindowScene: UIWindowScene? {
