...
class UserGroupViewController: UITableViewController, PanModalPresentable {
  ...
  let headerPresentable = UserGroupHeaderPresentable(handle: "ios-engs", description: "iOS Engineers", memberCount: 10)
  ...
  var shortFormHeight: PanModalHeight {
    isShortFormEnabled ? .contentHeight(300.0) : longFormHeight
  }
